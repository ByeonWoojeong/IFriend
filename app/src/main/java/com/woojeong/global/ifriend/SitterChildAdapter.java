...
public class SitterChildAdapter extends BaseAdapter {
    Context context;
    int layout;
    ArrayList<Three> data;
    ListView listView;
    AQuery aQuery = null;
    SitterChildAdapter sitterChildAdapter = this;
    String type;

    public SitterChildAdapter(Context context, int layout, ArrayList<Three> data, ListView listView, String type) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Three item = data.get(position);
